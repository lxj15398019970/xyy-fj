...
public class ExcelUtil {
    ...
    /**
     * @param file
     * @param maxCell 最大列数,起始列为0，以此类推
     * @return key由0开始到maxCell
     */
    public static List<Map<Integer, String>> poiRead(File file,
                                                     int maxCell, String fileName) {
     ...
     * 读取2003格式的excel文件
     *
     * @param input  不能为null,内部关闭流
     * @param titles 不能为null
     * @return
     */
