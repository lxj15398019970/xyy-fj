package cn.ld.fj.functional.account;
...
import cn.ld.fj.functional.BaseFunctionalTestCase;
import cn.ld.fj.functional.Gui;
import cn.ld.fj.functional.Gui.UserColumn;
import net.esoar.modules.test.groups.Groups;
...
public class SecurityTest extends BaseFunctionalTestCase {
	...
	public void checkAnonymous() {
		...
		assertEquals("esoar-web 登录页", driver.getTitle());
